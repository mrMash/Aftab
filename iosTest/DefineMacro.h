...
#define WebApi_Train @"3zmcy"

#define WebApi_Buss @"37yzm"

#define WebApi_Flight @"w60i"



#define kTitle @"iOS Test"
#define EntityTrain @"Train"
#define EntityBuss @"Busses"
#define EntityFlight @"Flight"
#define sortings @"sorting"
